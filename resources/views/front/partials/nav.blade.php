{{-- <nav class="site-nav" id="siteNav" role="navigation" aria-label="Main navigation">
    <div class="container">
        <a href="/" class="nav-logo" aria-label="{{ $gs['site_name'] ?? 'Dharsika' }} – Home">
        ...
        <div class="nav-cta-wrap" style="display:flex;align-items:center;gap:12px">
            ...
            <a href="{{ route('products.view') }}" class="btn btn-primary nav-cta" style="padding:7px 14px;font-size:.75rem">
                Products
            </a>
        </div>
