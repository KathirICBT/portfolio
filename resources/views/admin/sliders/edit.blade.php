...
@section('page-subtitle','Update hero slider content')
            ...
            <div class="card">
                ...
                <div class="card-body" style="display:flex;flex-direction:column;gap:18px">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="subtitle" class="form-control" rows="3" maxlength="600">{{ old('subtitle', $slider->subtitle) }}</textarea>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-grid" style="margin-bottom:16px">
                        <div class="form-group">
                            ...
                            <input type="text" name="cta1_label" class="form-control" maxlength="100"
                                   value="{{ old('cta1_label', $slider->cta1_label) }}" placeholder="e.g. Book a Free Consultation">
                        </div>
                        <div class="form-group">
                            <label class="form-label">CTA 1 URL</label>
                            <input type="text" name="cta1_url" class="form-control" maxlength="255"
                                   value="{{ old('cta1_url', $slider->cta1_url) }}" placeholder="#contact">
                        </div>
                    </div>
                    <div class="form-grid">
                        <div class="form-group">
                            <label class="form-label">CTA 2 Label (Optional)</label>
                            <input type="text" name="cta2_label" class="form-control" maxlength="100"
                                   value="{{ old('cta2_label', $slider->cta2_label) }}" placeholder="e.g. Learn More">
                        </div>
                        <div class="form-group">
                            <label class="form-label">CTA 2 URL</label>
                            <input type="text" name="cta2_url" class="form-control" maxlength="255"
                                   value="{{ old('cta2_url', $slider->cta2_url) }}" placeholder="#about">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div style="display:flex;gap:10px;align-items:center">
                                ...
                                <input type="text" class="form-control" value="{{ old('overlay_color', $slider->overlay_color) }}" placeholder="#1A3A5C" style="flex:1" readonly>
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <div style="display:flex;flex-direction:column;gap:20px">
                ...
                <div class="card-body" style="display:flex;flex-direction:column;gap:16px">
                    <div class="form-group">
                        ...
                        <input type="number" name="sort_order" class="form-control"
                               value="{{ old('sort_order', $slider->sort_order) }}" min="1">
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.media.index') }}" target="_blank" class="btn btn-outline btn-sm" style="margin-top:10px">Upload New Image →</a>
                </div>
            </div>

            <div style="display:flex;gap:10px">
                <button type="submit" class="btn btn-primary" style="flex:1;justify-content:center">Update Slide</button>
